...
public class UserTest {
	...
	public final void testNewUserPositive() {
		User newUser = newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(QUESTION)
	...
	public final void testWithBlankName() {
		newUser().setUsername(emptyString()).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithBlankNumber() {
		newUser().setUsername(USERNAME).setPassword(emptyString()).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithBlankEmail() {
		newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(emptyString()).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithWrongEmail() {
		newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(WRONGEMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithBlankQuestion() {
		newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(emptyString())
				.setAnswer(ANSWER).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithBlankAnswern() {
		newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(emptyString()).build();
	}
	...
	public final void testEquals() {
		User newUser1 = newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
		User newUser2 = newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
		User newUser3 = newUser().setUsername(USERNAME).setPassword(PASSWORD).setEmail(EMAIL2).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
		User newUser4 = newUser().setUsername(USERNAME2).setPassword(PASSWORD2).setEmail(EMAIL).setQuestion(QUESTION)
				.setAnswer(ANSWER).build();
