...
public class ZipBackupRestoreTest {
    ...
    public void setUp() throws IOException {
        ...
        FileStore<Activity> actStore = new FileStore<Activity>(fileact, () -> Activity.class);
        FileStore<Booking> bookStore = new FileStore<Booking>(fileact, () -> Booking.class);
        FileStore<User> userStore = new FileStore<User>(fileact, () -> User.class);
    ...
    private void createTestFiles() throws IOException {
        ...
        FileUtils.write(file1, CONTENT1, defaultCharset());
        FileUtils.write(file2, CONTENT2, defaultCharset());
        FileUtils.write(file3, CONTENT3, defaultCharset());
    }
