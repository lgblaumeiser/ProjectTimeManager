...
public class ActivityTest {
	...
	public final void testNewActivityPositive() {
		Activity newActivity = newActivity().setActivityName(ACTIVITY_1_1).setBookingNumber(BOOKINGN_1).build();
	...
	public final void testWithBlankName() {
		newActivity().setActivityName(emptyString()).setBookingNumber(BOOKINGN_1).build();
	}

	@Test(expected = IllegalStateException.class)
	public final void testWithBlankNumber() {
		newActivity().setActivityName(ACTIVITY_1_1).setBookingNumber(emptyString()).build();
	}
	...
	public final void testEquals() {
		Activity newActivity1 = newActivity().setActivityName(ACTIVITY_1_1).setBookingNumber(BOOKINGN_1).build();
		Activity newActivity2 = newActivity().setActivityName(ACTIVITY_1_2).setBookingNumber(BOOKINGN_1).build();
		Activity newActivity3 = newActivity().setActivityName(ACTIVITY_2).setBookingNumber(BOOKINGN_2).build();
		Activity newActivity4 = newActivity().setActivityName(ACTIVITY_1_1).setBookingNumber(BOOKINGN_1).build();
